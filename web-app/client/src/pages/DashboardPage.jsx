...
const DashboardPage = () => {
  ...
  const projects = [
    { id: '1', name: 'Urban Tower Complex', lastUpdated: '2 days ago', status: 'design', progress: 45, aiRecommendations: 12 },
    { id: '2', name: 'Residential High-Rise', lastUpdated: '1 week ago', status: 'estimation', progress: 78, aiRecommendations: 8 },
    { id: '3', name: 'Commercial Plaza', lastUpdated: '3 weeks ago', status: 'completed', progress: 100, aiRecommendations: 0 },
    { id: '4', name: 'Mixed-Use Development', lastUpdated: '1 month ago', status: 'analysis', progress: 32, aiRecommendations: 5 },
  ];
                  ...
                  <nav>
                    <ul className="space-y-1">
                      {[
                        ...
                        { name: 'Estimations', icon: <FaCog className="h-5 w-5 mr-3" /> },
                        { name: 'Material Library', icon: <FaBuilding className="h-5 w-5 mr-3" /> },
                        { name: 'Reports', icon: <FaChartLine className="h-5 w-5 mr-3" /> },
                        { name: 'Team', icon: <FaHardHat className="h-5 w-5 mr-3" /> },
                      ].map((item) => (
                        <motion.li 
                          key={item.name}
                          whileHover={{ x: 5 }}
            ...
            <div className="relative z-10 max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-white text-blue-900 font-bold py-3 px-6 rounded-lg shadow-lg"
